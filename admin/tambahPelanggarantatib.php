...
if (isset($_POST["tambah"])) {
  ...
  $row = $stmt->rowCount();
  if ($row >= 1) {
    header('Location: /desi/admin/pelanggaran.php?pesanGagal=Data%20pelanggaran%20yang%20anda%20masukkan%20sudah%20ada,%20silahkan%20masukkan%20data%20lainnya!&runFunction=getPelanggarantatib');
    exit();
  }
  else {
    ...
    $insert->execute();
    header('Location: /desi/admin/pelanggaran.php?pesanSuccess=Data%20berhasil%20ditambahkan!&runFunction=getPelanggarantatib');
    exit();
  }
}
?>
