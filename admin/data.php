...
<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark">
    <a href="/desi/admin/data.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <span class="fs-4">DATA</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      <li><a href="#" id="guru" class="nav-link text-white">Guru</a></li>
      <li><a href="#" id="jurusan" class="nav-link text-white">Jurusan</a></li>
      <li><a href="#" id="kelas" class="nav-link text-white">Kelas</a></li>
