...
if (isset($_POST["edit"])) {
  ...
  if ($row >= 1) {
    header('Location: /desi/guru/pelanggaran.php?pesanGagal=Data%20tata%20tertib%20yang%20anda%20masukkan%20sudah%20ada,%20silahkan%20masukkan%20data%20lainnya!&runFunction=getPelanggarantatib');
    exit();
  }
  else {
    ...
    $update->execute();
    header('Location: /desi/guru/pelanggaran.php?pesanSuccess=Data%20berhasil%20di%20edit&runFunction=getPelanggarantatib');
    exit();
  }
}
