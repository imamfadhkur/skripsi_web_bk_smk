...
if (isset($_POST["submitEditSiswa"])) {
  ...
  if ($row >= 1) {
    header('Location: /desi/guru/data.php?pesanGagal=Data(nisn)%20yang%20anda%20masukkan%20sudah%20ada,%20silahkan%20masukkan%20data%20lainnya!&runFunction=getDataSiswa');
    exit();
  }
  elseif (isset($_POST["password"])) { 
    ...
    header('Location: /desi/guru/data.php?pesanSuccess=Data%20berhasil%20di%20edit&runFunction=getDataSiswa');
    exit();
  }
  else {
    $cekJurusan = $con_pdo->prepare("SELECT jurusan FROM kelas WHERE nama = :nama");
